...
<body class="main-layout">
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        ...
                                        <li><a href="#blog">Portofolio</a></li>
    ...
    <section class="slider_section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="full">
                        <h1><strong class="cur">Hi!</strong><br>Im, Adam Yaksyaputra Hadian</h1>
                            <p>Im a Student at Bina Nusantara University Malang</p>
                            <div class="button_section"><a class="main_bt" href="#">My Biodata</a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="full text_align_center">
                        <img class="slide_img" src="images/profile.png" alt="#" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="about" class="about layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive" src="images/Binus.png" alt="#" />
                </div>
                <div class="col-md-6">
                    ...
                    <div class="full margin_top_20">
                        <p>Mahasiswa Aktif Bina Nusantara University B2025. Lahir di Malang pada 14 Oktober 2002. Memiliki Hobi Berolahraga dan Bermain Game</p>
                    </div>
            ...
            <div class="row">
               <div class="col-md-12">
                    <div class="heading full text_align_center">
                        <h2 class="white_font full text_align_center">My Latest Activities</h2>
                    </div>
                </div>
            </div>
            <div class="row">
               <div class="col-md-4 margin_top_30">
                    <div class="full fr">
                        <img class="img-responsive" src="images/Pro1.jpeg" alt="#" />
                    </div>

                </div>
                <div class="col-md-4 margin_top_30">
                    <div class="full fr">
                        <img class="img-responsive" src="images/Pro2.jpeg" alt="#" />
                    </div>

                </div>
                <div class="col-md-4 margin_top_30">
                    <div class="full fr">
                        <img class="img-responsive" src="images/Pro3.jpeg" alt="#" />
                    </div>
    ...
    <div id="blog" class="section dark_bg layout_padding right_white">
        <div class="container">
            <div class="row">
               <div class="col-md-12">
                    <div class="heading full text_align_center">
                        <h2 class="white_font full text_align_center">My Experience</h2>
                    </div>
                </div>
            </div>
            <div class="row">
               <div class="col-md-4 margin_top_30">
                    ...
                    <div class="full bl">
                        <img class="img-responsive" src="images/kssh.jpeg" alt="#" />
                    </div>
                    <div class="full blog_blue text_align_center">
                        <h5 class="white_font">KSSH Coordinator</h3>
                        <p>Salah satu koordinator pentas seni SMA 8.</p>
                    </div>
                     </div>
                </div>
                <div class="col-md-4 margin_top_30">
